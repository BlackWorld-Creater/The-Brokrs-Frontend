...
function NewChatModal({ onClose, onSelectUser, onCreateGroup }) {
  ...
  return (
    ...
    >
      <div
        className="modal-content w-[92vw] sm:w-full max-h-[90vh] overflow-y-auto"
        style={{ maxWidth: 420 }}
      >
        <div
...
function MessageBubble({
  ...
  return (
    ...
    >
      ...
      <div
        className={`flex flex-col w-full sm:w-auto max-w-[88%] sm:max-w-[75%] lg:max-w-[70%] ${isMine ? "items-end" : "items-start"}`}
      >
        {/* Sender name */}
        {!isMine && showAvatar && (
          <span
        ...
        <div className="relative">
          ...
          {!isDeleted && (
            <div
              className={`absolute -top-8 sm:top-0 ${isMine ? "right-0 sm:right-full sm:mr-1" : "left-0 sm:left-full sm:ml-1"} opacity-100 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity flex items-center gap-0.5 z-10`}
            >
              {/* Quick react */}
              <div className="relative">
                <button
...
export default function ChatPage() {
  ...
  return (
    <div
      className="relative flex h-[calc(100vh-5rem)] sm:h-[calc(100vh-6rem)] lg:h-[calc(100vh-8rem)] rounded-2xl overflow-hidden"
      style={{
        border: "1px solid rgba(var(--border))",
        background: "rgb(var(--bg-card))",
      }}
      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={() => setShowSidebarMobile(false)}
              className="w-8 h-8 rounded-xl flex items-center justify-center lg:hidden"
              style={{
                background: "rgba(var(--bg-hover))",
                border: "1px solid rgba(var(--border))",
              }}
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center justify-between mt-0.5 gap-2">
                      ...
                      {unread > 0 && (
                        <span
                          className="flex-shrink-0 min-w-[20px] h-5 rounded-full flex items-center justify-center text-white font-bold"
                          style={{
      ...
      <div className="flex-1 flex flex-col min-w-0 w-full">
        {activeRoom ? (
          <>
            {/* Chat header */}
            <div
              className="flex items-center gap-3 px-3 sm:px-4 lg:px-5 py-3 flex-shrink-0"
              style={{ borderBottom: "1px solid rgba(var(--border))" }}
            >
              <button
              ...
              >
                <Menu size={16} style={{ color: "rgb(var(--text-primary))" }} />
              </button>
            ...
            <div
              ...
              className="flex-1 overflow-y-auto px-3 sm:px-4 lg:px-5 py-4 space-y-0.5"
            >
              {hasMore && (
                <div className="text-center py-2">
                  {loadingMore ? (
              ...
              {Object.entries(groupedMessages).map(([day, dayMsgs]) => (
                <div key={day}>
                  <div className="flex items-center gap-2 sm:gap-3 my-4">
                    ...
                    />
                    <span
                      className="text-[11px] sm:text-xs px-2 py-0.5 rounded-full whitespace-nowrap"
                      style={{
                        background: "rgba(var(--bg-hover))",
                        color: "rgb(var(--text-muted))",
                      }}
            ...
            {showScrollBtn && (
              <button
                ...
                className="absolute bottom-24 right-4 sm:right-6 lg:right-8 w-9 h-9 rounded-full flex items-center justify-center shadow-lg z-20"
            ...
            {/* Input bar */}
            <div
              className="px-3 sm:px-4 py-3 flex items-end gap-2 sm:gap-3"
              style={{ borderTop: "1px solid rgba(var(--border))" }}
            >
              <div className="flex-1 relative min-w-0">
                <textarea
                  ref={inputRef}
                  className="input-field resize-none pr-3 py-3 text-sm sm:text-base"
          ...
          <div className="flex-1 flex flex-col items-center justify-center gap-4 px-4 text-center">
            <button
              onClick={() => setShowSidebarMobile(true)}
              className="w-11 h-11 rounded-xl flex items-center justify-center lg:hidden"
              style={{
                background: "rgba(var(--bg-hover))",
                border: "1px solid rgba(var(--border))",
              }}
